#ifndef CM3D_GL_SHADER_PROGRAM
#define CM3D_GL_SHADER_PROGRAM

#include "cmcommon.h"
#include "BasicTypes.h"

#include </run/media/Michael/CE3E90D43E90B745/Libs/glad/include/glad/gl.h>
#include </run/media/Michael/CE3E90D43E90B745/Libs/glm/glm/gtc/type_ptr.hpp>

#include <vector>
#include <string>
#include <map>

// Supports #pragma cm3d_include <path>
...
#define CM3D_GL_SHADER_EXTRA_IO
	...
	inline std::map<GLenum, std::vector<GLuint>> &getShaders() {
		return compiledShaders;
	}
	inline std::map<GLenum, GLuint> &getSelected() {
		return selectedShaders;
	}
	inline std::map<const GLchar *, GLint> &getUniformLocCache() {
...
protected:
	...
	std::map<GLenum, std::vector<GLuint>> compiledShaders;
	
	// Stores indexes of selected shaders
	std::map<GLenum, unsigned> selectedShaders;
